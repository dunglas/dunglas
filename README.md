...
- [symfony/messenger](https://github.com/symfony/messenger) ([v7.3.0-BETA2](https://github.com/symfony/messenger/releases/tag/v7.3.0-BETA2), 1 day ago) - Helps applications send and receive messages to/from other applications or via message queues
- [symfony/framework-bundle](https://github.com/symfony/framework-bundle) ([v7.3.0-BETA2](https://github.com/symfony/framework-bundle/releases/tag/v7.3.0-BETA2), 1 day ago) - Provides a tight integration between Symfony components and the Symfony full-stack framework

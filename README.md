...
- [SymfonyCasts/micro-mapper](https://github.com/SymfonyCasts/micro-mapper) - A tiny, underwhelming data mapper for Symfony to map one object to another! (4 days ago)
...
- [scheb/2fa](https://github.com/scheb/2fa) ([v6.13.0](https://github.com/scheb/2fa/releases/tag/v6.13.0), 3 days ago) - Two-factor authentication for Symfony applications 🔐
...
- [symfony/serializer](https://github.com/symfony/serializer) ([v7.2.0](https://github.com/symfony/serializer/releases/tag/v7.2.0), 3 days ago) - Handles serializing and deserializing data structures, including object graphs, into array structures or other formats like XML and JSON.

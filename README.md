...
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v5.2.10](https://github.com/symfony/http-foundation/releases/tag/v5.2.10), today) - The HttpFoundation component defines an object-oriented layer for the HTTP specification.
- [symfony/dependency-injection](https://github.com/symfony/dependency-injection) ([v5.2.10](https://github.com/symfony/dependency-injection/releases/tag/v5.2.10), today) - The DependencyInjection component allows you to standardize and centralize the way objects are constructed in your application.

...
- [quic-go/quic-go](https://github.com/quic-go/quic-go) ([v0.37.2](https://github.com/quic-go/quic-go/releases/tag/v0.37.2), 1 day ago) - A QUIC implementation in pure go
...
- [6x faster Docker builds for Symfony and API Platform projects](https://dunglas.dev/2023/08/6x-faster-docker-builds-for-symfony-and-api-platform-projects/) (3 days ago)

...
- [symfony/http-kernel](https://github.com/symfony/http-kernel) ([v6.1.3](https://github.com/symfony/http-kernel/releases/tag/v6.1.3), 3 days ago) - The HttpKernel component provides a structured process for converting a Request into a Response.

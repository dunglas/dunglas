...
- [api-platform/core](https://github.com/api-platform/core) ([v3.4.0-alpha.4](https://github.com/api-platform/core/releases/tag/v3.4.0-alpha.4), 2 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
- [ikarus23/MifareClassicTool](https://github.com/ikarus23/MifareClassicTool) ([v4.2.3](https://github.com/ikarus23/MifareClassicTool/releases/tag/v4.2.3), 5 days ago) - An Android NFC app for reading, writing, analyzing, etc. MIFARE Classic RFID tags.

...
- [symfony/web-link](https://github.com/symfony/web-link) ([v7.3.0-RC1](https://github.com/symfony/web-link/releases/tag/v7.3.0-RC1), 1 day ago) - Manages links between resources
- [symfony/serializer](https://github.com/symfony/serializer) ([v7.3.0-RC1](https://github.com/symfony/serializer/releases/tag/v7.3.0-RC1), 1 day ago) - Handles serializing and deserializing data structures, including object graphs, into array structures or other formats like XML and JSON.
- [symfony/messenger](https://github.com/symfony/messenger) ([v7.3.0-RC1](https://github.com/symfony/messenger/releases/tag/v7.3.0-RC1), 1 day ago) - Helps applications send and receive messages to/from other applications or via message queues

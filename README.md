...
- [quic-go/quic-go](https://github.com/quic-go/quic-go) ([v0.37.3](https://github.com/quic-go/quic-go/releases/tag/v0.37.3), 2 days ago) - A QUIC implementation in pure go

#### 📜 My recent [blog posts](https://dunglas.fr)

- [6x faster Docker builds for Symfony and API Platform projects](https://dunglas.dev/2023/08/6x-faster-docker-builds-for-symfony-and-api-platform-projects/) (5 days ago)

...
- [symfony/serializer](https://github.com/symfony/serializer) ([v7.1.5](https://github.com/symfony/serializer/releases/tag/v7.1.5), 1 day ago) - Handles serializing and deserializing data structures, including object graphs, into array structures or other formats like XML and JSON.
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v7.1.5](https://github.com/symfony/http-foundation/releases/tag/v7.1.5), 1 day ago) - Defines an object-oriented layer for the HTTP specification
...
- [API Platform for Laravel](https://dunglas.dev/2024/09/api-platform-for-laravel/) (3 days ago)

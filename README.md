...
- [buraksezer/olric](https://github.com/buraksezer/olric) ([v0.4.0-beta.10](https://github.com/buraksezer/olric/releases/tag/v0.4.0-beta.10), today) - Distributed cache and in-memory key/value data store. It can be used both as an embedded Go library and as a language-independent service.

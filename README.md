...
- [vercel/next.js](https://github.com/vercel/next.js) ([v13.1.3-canary.1](https://github.com/vercel/next.js/releases/tag/v13.1.3-canary.1), today) - The React Framework
...
- [api-platform/api-platform](https://github.com/api-platform/api-platform) ([v3.0.9](https://github.com/api-platform/api-platform/releases/tag/v3.0.9), 3 days ago) - Create REST and GraphQL APIs, scaffold Jamstack webapps, stream changes in real-time.

#### 📜 My recent [blog posts](https://dunglas.fr)

- [Read the Linux Manual Pages on Mac and BSD, Directly From the Terminal](https://dunglas.dev/2022/12/read-the-linux-manual-pages-on-mac-and-bsd-directly-from-the-terminal/) (4 weeks ago)
...
- [toofff](https://github.com/toofff) (1 day ago)

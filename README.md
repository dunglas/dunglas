...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) ([v5.2.15](https://github.com/mdn/browser-compat-data/releases/tag/v5.2.15), 2 days ago) - This repository contains compatibility data for Web technologies as displayed on MDN
- [vercel/next.js](https://github.com/vercel/next.js) ([v13.0.3](https://github.com/vercel/next.js/releases/tag/v13.0.3), 2 days ago) - The React Framework
- [symfony/ux](https://github.com/symfony/ux) ([v2.5.0](https://github.com/symfony/ux/releases/tag/v2.5.0), 5 days ago) - Symfony UX initiative: a new JavaScript ecosystem for Symfony
...
- [senzowayne](https://github.com/senzowayne) (5 days ago)

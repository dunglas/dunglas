...
- [vercel/next.js](https://github.com/vercel/next.js) ([v13.4.5-canary.4](https://github.com/vercel/next.js/releases/tag/v13.4.5-canary.4), 1 day ago) - The React Framework
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) ([v5.2.61](https://github.com/mdn/browser-compat-data/releases/tag/v5.2.61), 1 day ago) - This repository contains compatibility data for Web technologies as displayed on MDN
- [dunglas/solid-client-php](https://github.com/dunglas/solid-client-php) ([v1.0.0](https://github.com/dunglas/solid-client-php/releases/tag/v1.0.0), 2 days ago) - PHP library for accessing data and managing permissions on data stored in a Solid Pod

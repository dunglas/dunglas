...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ([v2.1.0](https://github.com/hoppscotch/hoppscotch/releases/tag/v2.1.0), 1 day ago) - 👽 Open source API development ecosystem https://hoppscotch.io
...
- [vmware-tanzu/helm-charts](https://github.com/vmware-tanzu/helm-charts) ([velero-2.26.2](https://github.com/vmware-tanzu/helm-charts/releases/tag/velero-2.26.2), 1 week ago) - Contains Helm charts for Kubernetes related open source tools
- [symfony/validator](https://github.com/symfony/validator) ([v5.3.10](https://github.com/symfony/validator/releases/tag/v5.3.10), 1 week ago) - The Validator component provides tools to validate values following the JSR-303 Bean Validation specification.
...
- [symfony/http-kernel](https://github.com/symfony/http-kernel) ([v5.3.10](https://github.com/symfony/http-kernel/releases/tag/v5.3.10), 1 week ago) - The HttpKernel component provides a structured process for converting a Request into a Response.
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v5.3.10](https://github.com/symfony/http-foundation/releases/tag/v5.3.10), 1 week ago) - The HttpFoundation component defines an object-oriented layer for the HTTP specification.
- [symfony/dependency-injection](https://github.com/symfony/dependency-injection) ([v5.3.10](https://github.com/symfony/dependency-injection/releases/tag/v5.3.10), 1 week ago) - The DependencyInjection component allows you to standardize and centralize the way objects are constructed in your application.
- [symfony/config](https://github.com/symfony/config) ([v5.3.10](https://github.com/symfony/config/releases/tag/v5.3.10), 1 week ago) - The Config component helps you find, load, combine, autofill and validate configuration values of any kind, whatever their source may be (YAML, XML, INI files, or for instance a database).

...
- [hwi/HWIOAuthBundle](https://github.com/hwi/HWIOAuthBundle) ([1.4.0](https://github.com/hwi/HWIOAuthBundle/releases/tag/1.4.0), today) - OAuth client integration for Symfony. Supports both OAuth1.0a and OAuth2.
- [symfony/validator](https://github.com/symfony/validator) ([v4.4.27](https://github.com/symfony/validator/releases/tag/v4.4.27), today) - The Validator component provides tools to validate values following the JSR-303 Bean Validation specification.
- [symfony/serializer](https://github.com/symfony/serializer) ([v4.4.27](https://github.com/symfony/serializer/releases/tag/v4.4.27), today) - With the Serializer component it&#39;s possible to handle serializing data structures, including object graphs, into array structures or other formats like XML and JSON. It can also handle deserializing XML and JSON back to object graphs.
- [symfony/routing](https://github.com/symfony/routing) ([v4.4.27](https://github.com/symfony/routing/releases/tag/v4.4.27), today) - The Routing component maps an HTTP request to a set of configuration variables.
- [symfony/http-kernel](https://github.com/symfony/http-kernel) ([v4.4.27](https://github.com/symfony/http-kernel/releases/tag/v4.4.27), today) - The HttpKernel component provides a structured process for converting a Request into a Response.
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v4.4.27](https://github.com/symfony/http-foundation/releases/tag/v4.4.27), today) - The HttpFoundation component defines an object-oriented layer for the HTTP specification.
- [symfony/dependency-injection](https://github.com/symfony/dependency-injection) ([v4.4.27](https://github.com/symfony/dependency-injection/releases/tag/v4.4.27), today) - The DependencyInjection component allows you to standardize and centralize the way objects are constructed in your application.
- [symfony/config](https://github.com/symfony/config) ([v4.4.27](https://github.com/symfony/config/releases/tag/v4.4.27), today) - The Config component helps you find, load, combine, autofill and validate configuration values of any kind, whatever their source may be (YAML, XML, INI files, or for instance a database).
- [symfony/twig-bundle](https://github.com/symfony/twig-bundle) ([v4.4.27](https://github.com/symfony/twig-bundle/releases/tag/v4.4.27), today) - The Twig Bundle provides configuration for using Twig in your applications.
- [symfony/framework-bundle](https://github.com/symfony/framework-bundle) ([v4.4.27](https://github.com/symfony/framework-bundle/releases/tag/v4.4.27), today) - The FrameworkBundle defines the main framework configuration, from sessions and translations to forms, validation, routing and more.

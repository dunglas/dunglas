...
- [api-platform/admin](https://github.com/api-platform/admin) ([v3.4.7](https://github.com/api-platform/admin/releases/tag/v3.4.7), 2 days ago) - A beautiful and fully-featured administration interface builder for hypermedia APIs
- [api-platform/demo](https://github.com/api-platform/demo) ([v3.3.3](https://github.com/api-platform/demo/releases/tag/v3.3.3), 2 days ago) - Demo app for the API Platform framework
...
- [mgionas](https://github.com/mgionas) (4 weeks ago)

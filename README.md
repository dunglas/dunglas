...
- [cloudflare/cloudflare-go](https://github.com/cloudflare/cloudflare-go) ([v0.13.6](https://github.com/cloudflare/cloudflare-go/releases/tag/v0.13.6), 1 day ago) - Go library for the Cloudflare v4 API
- [buraksezer/olric](https://github.com/buraksezer/olric) ([v0.3.1](https://github.com/buraksezer/olric/releases/tag/v0.3.1), 3 days ago) - Distributed cache and in-memory key/value data store. It can be used both as an embedded Go library and as a language-independent service.
- [apache/pulsar](https://github.com/apache/pulsar) ([v2.7.0](https://github.com/apache/pulsar/releases/tag/v2.7.0), 5 days ago) - Apache Pulsar - distributed pub-sub messaging system
- [api-platform/api-platform](https://github.com/api-platform/api-platform) ([v2.6.0-alpha.1](https://github.com/api-platform/api-platform/releases/tag/v2.6.0-alpha.1), 6 days ago) - REST and GraphQL framework to build modern API-driven projects (server-side and client-side)
- [api-platform/core](https://github.com/api-platform/core) ([v2.6.0-alpha.1](https://github.com/api-platform/core/releases/tag/v2.6.0-alpha.1), 6 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
...
- [API Platform 2.6: PHP 8 support, Next.js and Nuxt.js app generator, Caddy server, ActivityPub and much more!](http://feedproxy.google.com/~r/dunglas/~3/X1dkcrZS-qU/) (5 days ago)
...
- [Working on API Platform during #SymfonyHackday](https://gist.github.com/3949272d40e6390cdd2850a4f312a02a) (3 days ago)
...
- [jraller](https://github.com/jraller) (5 days ago)
- [sroze](https://github.com/sroze) (5 days ago)
- [andreaswarnaar](https://github.com/andreaswarnaar) (5 days ago)
- [davidgorges](https://github.com/davidgorges) (1 week ago)
- [alexislefebvre](https://github.com/alexislefebvre) (2 weeks ago)
